...
1. Loosely install a `M5x8-bolt` and `M5-t-nut` onto 2x `corner-bracket` 
	<img style="height:500px;" src="img/feeder-slot-rail-5.webp">
	<img style="height:500px;" src="img/feeder-slot-rail-6.webp">
2. Position a `corner-bracket` onto the front left side of the `alu-extrusion` previously placed in the `feeder-rail-asm-jig`
...
### Mirror the Corner Brackets

1. Repeat the previous two steps on the opposite side of `alu-extrusion`  
	<img style="height:500px;" src="img/feeder-slot-rail-10.webp">
2. Confirm the WIP `front-feeder-rail` matches the image below
...
1. Repeat the previous two steps on the opposite side of `alu-extrusion`  
	<img style="height:500px;" src="img/feeder-slot-rail-10.webp">
2. Confirm the WIP `rear-feeder-rail` matches the image below before proceeding to install 2x `corner-bracket` on the backside of the `alu-extrusion`
	<img style="height:500px;" src="img/feeder-slot-rail-11.webp">
3.	Position a `corner-bracket` onto the back right side of the `alu-extrusion`
	
	<img style="height:500px;" src="img/feeder-slot-rail-35.webp">

### Install Back Corner Brackets

1. Press the `corner-bracket` downward and inward (towards the sidewall of the jig) while tightening the `M5x8-bolt` to `0.7N/M`
	<img style="height:500px;" src="img/feeder-slot-rail-36.webp">
	<img style="height:500px;" src="img/feeder-slot-rail-37.webp">
2. Repeat the previous two steps to install a `corner-bracket` onto the back left side of `alu-extrusion`  
	<img style="height:500px;" src="img/feeder-slot-rail-38.webp">
3. Confirm the WIP `rear-feeder-rail` matches the image below

...
### No-Cable Variant: Build the Camera Tray

The purpose of this work instruction is to guide the reader on how to produce the two variants of the `LumenPnP v4 USB Camera Set`: `LumenPnP v4 USB Camera Set - No Cables` (a set of LumenPnP v4 cameras in a foam tray, taped closed with 2 stickers adhered to the outside) and `LumenPnP v4 USB Camera Set - Cables Included` (a bagged version of the above product that also includes the `top-camera-harness` and `bottom-camera-harness`).
...
### No-Cable Variant: Assemble the Tray and Lid
...
### No-Cable Variant: Label and Finish
...
### With-Cables Variant: Build the Camera Tray
...
### With-Cables Variant: Assemble the Tray and Lid
...
### With-Cables Variant: Label the Tray

...
# LumenPnPv4 Drag Chain Assembly Kit

## Instructions

### Create `LumenPnP v4 Drag Chain Cable Set` (Cables)
...
### Create `LumenPnP v4 Drag Chain Cable Set` (Harnesses)

1. Place the bagged `x-harness` into the 6x9-bag used previously

2. Collect a `top-camera-harness` from inventory and coil it up with a `twist-tie` before placing it into a `3x6-bag`

    ![alt text](img/v4-drag-chain-kit-8.webp)
    ![alt text](img/v4-drag-chain-kit-13.webp)

3. Place the bagged `top-camera-harness` into the 6x9-bag used previously

    ![alt text](img/v4-drag-chain-kit-9.webp)

4. Adhere a `LumenPnP v4 Drag Chain Cable Set` label to the 6x9-bag used previously
...
1. Attach lumenpnp-drag-chain-set` , `LumenPnP v4 Drag Chain Cable Set` , and `x-cable-chain-support` all together with 2x `rubber-band`

    ![alt text](img/v4-drag-chain-kit-16.webp)
    ![alt text](img/v4-drag-chain-kit-17.webp)
    ![alt text](img/v4-drag-chain-kit-18.webp)

2. Attach the `LumenPnPv4 Drag Chain Assembly Kit product label` to the bundle by sliding the sticker under the rubbber bands
